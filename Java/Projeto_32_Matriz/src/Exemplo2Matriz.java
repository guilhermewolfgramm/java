        ...
        public static void main(String[] args) {
            ...
            Scanner teclado = new Scanner(System.in);
             ...
             // Declaração da matriz
                ...
                for (int i = 0; i < numeros.length; i++){
                    somaLinhas = 0; // zera o acumulador de linhas toda vez que inicia u ma nova linha
                     for (int j = 0; j < numeros[i].length; j++){
        somaLinhas += numeros[i][j]; // acumula os somatório dos element o de cada linha
                    }
                     System.out.println("A soma da linha [" + i + "] é: " + somaLinhas);
                    total += somaLinhas; // acumula o somatório total dos elementos da m atriz
                }
